export default function Impressum() {
  return (
    <div>
      <p className="ml-8 mt-32">
        <br />Impressum <br /> <br />
        Angaben gemäß § 5 TMG <br /><br /> Unternehmensname: <br />Beispiel GmbH Vertreten durch: <br />
        Max Mustermann <br /><br />  Adresse: Musterstraße 1 <br /> 12345 Musterstadt <br /> <br />Kontakt:
        Telefon: +49 (0) 123 456 789 <br />E-Mail: info@beispiel.de <br /> <br />Registereintrag:
        Eintragung im Handelsregister. <br /> Registergericht: Amtsgericht Musterstadt <br />
        Registernummer: HRB 12345 <br /> <br />Umsatzsteuer-ID:
        Umsatzsteuer-Identifikationsnummer gemäß §27 a Umsatzsteuergesetz:
        DE123456789 <br /><br />  Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV: <br />Max
        Mustermann Musterstraße 1 <br /> 12345 Musterstadt <br /> <br /> Haftungsausschluss
        (Disclaimer) <br /> <br />Haftung für Inhalte <br /> Als Diensteanbieter sind wir gemäß § 7
        ...
        entfernen. <br /> <br />Haftung für Links <br /> Unser Angebot enthält Links zu externen
        ...
        erkennbar. <br /> <br />Eine permanente inhaltliche Kontrolle der verlinkten Seiten
        ...
        Links umgehend entfernen. <br /> <br /> Urheberrecht <br /> Die durch die Seitenbetreiber
        ...
        kommerziellen Gebrauch gestattet. <br /> <br />Soweit die Inhalte auf dieser Seite
