...
export function Header({ isLoggedIn, setIsLoggedIn }) {
  ...
  return (
    <header>
      <nav className="p-2 flex sm:bg-opacity-50 bg-opacity-100 sm:gap-14 gap-1 bg-white shadow-lg flex-col sm:flex-row sm:justify-center sm:items-center items-center fixed top-0 left-0 w-full">
